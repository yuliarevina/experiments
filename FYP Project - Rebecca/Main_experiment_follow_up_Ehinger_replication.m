...
inset = grating2(1:ceil(BS_size_pix/2)); % half the size of the BS
...
b1 = 0;
b2 = 0;
c1 = (BS_size_pix/4.5-5)/2; % standard deviation, 
c2 = (BS_size_pix/4.5-5)/2; % SD in the other orientation since we have an oval
