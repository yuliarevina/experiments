...
if ~IsWin %don't load if debugging on windows
...
%                     subjectdata(ntrials,5) = numFrames*ifi; % Record RT in secs using n of frames elapsed
