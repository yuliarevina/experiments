...
%         targetPoint = [squareX, windowRect(4)/2];
        ...
        targetPoint = [squareX, BS_center_v];
        
        % Center the rectangle on the centre of the screen
        centeredRect = CenterRectOnPointd(meas_stimRect, squareX, BS_center_v);
...
in_deg_h2 = pix2deg_YR_MRI(BS_diameter_h2)
title('horizontal 2');
